...
export function ImpactRadiusControl({ value, error, onChange }: {
  ...
  return (
    <fieldset aria-describedby={error ? 'simulation-radius-error' : 'simulation-radius-help'}>
      <legend className="font-semibold">Hesaplama Yarıçapı</legend>
      ...
      <p id="simulation-radius-help" className="mt-2 text-xs leading-5 text-text-secondary">Seçilen yarıçap boyunca azalım profili hesaplanır; hasar veya etki alanı değildir.</p>
