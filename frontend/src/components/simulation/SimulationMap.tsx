...
const MapLibreSimulationMap = lazy(() => import('./MapLibreSimulationMap'))
  ...
  return (
    <section aria-label="Simülasyon konumu haritası" aria-describedby="simulation-map-help"
      ...
      <div className="relative h-[360px] sm:h-[480px] lg:h-auto lg:min-h-[600px] lg:flex-1">
        <SimulationMapBoundary>
          <Suspense fallback={<SimulationMapState state="loading" />}>
            <MapLibreSimulationMap location={location} onSelect={onSelect} />
          </Suspense>
        </SimulationMapBoundary>
      </div>
